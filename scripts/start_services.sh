...
echo ""
echo "To upload a file:    cd $BUILD_DIR && ./client upload <filepath> [name]"
echo "To download a file:  cd $BUILD_DIR && ./client download <name> [output]"
echo "To list files:       cd $BUILD_DIR && ./client list"
echo ""
