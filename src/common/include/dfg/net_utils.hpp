...
inline int connect_with_timeout(const std::string& ip, int port, int timeout_sec = 5) {
...
inline void parse_address(const std::string& address, std::string& ip, int& port, int default_port = 8080) {
    ip = address;
    port = default_port;
